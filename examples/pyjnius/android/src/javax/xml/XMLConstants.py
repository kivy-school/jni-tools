...
class XMLConstants(JavaClass, metaclass=MetaJavaClass):
    ...
    ACCESS_EXTERNAL_DTD = JavaStaticField("Ljava/lang/String;")
    ACCESS_EXTERNAL_SCHEMA = JavaStaticField("Ljava/lang/String;")
    ACCESS_EXTERNAL_STYLESHEET = JavaStaticField("Ljava/lang/String;")
    USE_CATALOG = JavaStaticField("Ljava/lang/String;")