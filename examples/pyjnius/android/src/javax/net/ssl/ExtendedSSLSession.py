...
class ExtendedSSLSession(JavaClass, metaclass=MetaJavaClass):
    ...
    exportKeyingMaterialKey = JavaMethod("(Ljava/lang/String;Ljava/lang/String;[BI)Ljavax/crypto/SecretKey;")
    exportKeyingMaterialData = JavaMethod("(Ljava/lang/String;[BI)[B")