...
class InlineContentView:
    ...
    Y: ClassVar[Property]
    Z: ClassVar[Property]
    def setSurfaceControlCallback(self, p0: Any) -> None: ...
    def setZOrderedOnTop(self, p0: bool) -> bool: ...
    ...
    class SurfaceControlCallback:
        def onCreated(self, p0: SurfaceControl) -> None: ...
        def onDestroyed(self, p0: SurfaceControl) -> None: ...
