...
class RecognitionService(JavaClass, metaclass=MetaJavaClass):
    ...
    onTriggerModelDownload = JavaMultipleMethod([("(Landroid/content/Intent;Landroid/content/AttributionSource;Landroid/speech/ModelDownloadListener;)V", False, False), ("(Landroid/content/Intent;)V", False, False), ("(Landroid/content/Intent;Landroid/content/AttributionSource;)V", False, False)])
