...
class MediaBrowserService(JavaClass, metaclass=MetaJavaClass):
    ...
    onLoadChildren = JavaMultipleMethod([("(Ljava/lang/String;Landroid/service/media/MediaBrowserService$Result;Landroid/os/Bundle;)V", False, False), ("(Ljava/lang/String;Landroid/service/media/MediaBrowserService$Result;)V", False, False)])
