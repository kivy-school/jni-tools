...
class SpellCheckerService:
    ...
    def createSession(self) -> Any: ...
    def onBind(self, p0: Intent) -> IBinder: ...

    class Session:
        def __init__(self) -> None: ...
        def getSupportedAttributes(self) -> int: ...
        def onGetSentenceSuggestionsMultiple(self, p0: Any, p1: int) -> Any: ...
        def onGetSuggestions(self, p0: TextInfo, p1: int) -> SuggestionsInfo: ...
        def onGetSuggestionsMultiple(self, p0: Any, p1: int, p2: bool) -> Any: ...
