...
class CameraPrewarmService:
    ...
    def onCooldown(self, p0: bool) -> None: ...
...
class MediaBrowserService:
    ...
    def getCurrentBrowserInfo(self) -> Any: ...
    def getSessionToken(self) -> Any: ...
    @overload
    def notifyChildrenChanged(self, p0: str) -> None: ...
    @overload
    def notifyChildrenChanged(self, p0: str, p1: Bundle) -> None: ...
    def onGetRoot(self, p0: str, p1: int, p2: Bundle) -> Any: ...
    @overload
    def onLoadChildren(self, p0: str, p1: Any) -> None: ...
    @overload
    def onLoadChildren(self, p0: str, p1: Any, p2: Bundle) -> None: ...
    def onLoadItem(self, p0: str, p1: Any) -> None: ...
    def setSessionToken(self, p0: Any) -> None: ...
    def onBind(self, p0: Intent) -> IBinder: ...
    ...
    class Result:
        ...
        def sendResult(self, p0: Any) -> None: ...
