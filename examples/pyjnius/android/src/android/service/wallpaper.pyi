...
class WallpaperService:
    ...
    @overload
    def onCreateEngine(self) -> Any: ...
    @overload
    def onCreateEngine(self, p0: WallpaperDescription) -> Any: ...
    def onBind(self, p0: Intent) -> IBinder: ...
    def onCreate(self) -> None: ...
    def onDestroy(self) -> None: ...

    class Engine:
        def __init__(self, p0: "WallpaperService") -> None: ...
        def onSurfaceChanged(self, p0: SurfaceHolder, p1: int, p2: int, p3: int) -> None: ...
        def onSurfaceCreated(self, p0: SurfaceHolder) -> None: ...
        def onSurfaceDestroyed(self, p0: SurfaceHolder) -> None: ...
        ...
        def onApplyWallpaper(self, p0: int) -> WallpaperDescription: ...
        def onCommand(self, p0: str, p1: int, p2: int, p3: int, p4: Bundle, p5: bool) -> Bundle: ...
        def onComputeColors(self) -> WallpaperColors: ...
        def onDesiredSizeChanged(self, p0: int, p1: int) -> None: ...
        def onOffsetsChanged(self, p0: float, p1: float, p2: float, p3: float, p4: int, p5: int) -> None: ...
        def onSurfaceRedrawNeeded(self, p0: SurfaceHolder) -> None: ...
        def onWallpaperFlagsChanged(self, p0: int) -> None: ...
        def onZoomChanged(self, p0: float) -> None: ...
        def setOffsetNotificationsEnabled(self, p0: bool) -> None: ...
        def setTouchEventsEnabled(self, p0: bool) -> None: ...
        def isVisible(self) -> bool: ...
        def onApplyWindowInsets(self, p0: WindowInsets) -> None: ...
        def onVisibilityChanged(self, p0: bool) -> None: ...
        def onCreate(self, p0: SurfaceHolder) -> None: ...
        def onDestroy(self) -> None: ...
        def onTouchEvent(self, p0: MotionEvent) -> None: ...
