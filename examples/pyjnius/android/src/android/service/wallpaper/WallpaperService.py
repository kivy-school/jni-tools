...
class WallpaperService(JavaClass, metaclass=MetaJavaClass):
    ...
    onCreateEngine = JavaMultipleMethod([("()Landroid/service/wallpaper/WallpaperService$Engine;", False, False), ("(Landroid/app/wallpaper/WallpaperDescription;)Landroid/service/wallpaper/WallpaperService$Engine;", False, False)])
    ...
    class Engine(JavaClass, metaclass=MetaJavaClass):
        ...
        onApplyWallpaper = JavaMethod("(I)Landroid/app/wallpaper/WallpaperDescription;")
