...
class VpnService(JavaClass, metaclass=MetaJavaClass):
    ...
    class Builder(JavaClass, metaclass=MetaJavaClass):
        ...
        addRoute = JavaMultipleMethod([("(Landroid/net/IpPrefix;)Landroid/net/VpnService$Builder;", False, False), ("(Ljava/lang/String;I)Landroid/net/VpnService$Builder;", False, False), ("(Ljava/net/InetAddress;I)Landroid/net/VpnService$Builder;", False, False)])
        ...
        addDnsServer = JavaMultipleMethod([("(Ljava/lang/String;)Landroid/net/VpnService$Builder;", False, False), ("(Ljava/net/InetAddress;)Landroid/net/VpnService$Builder;", False, False)])
