...
class EthiopicCalendar(JavaClass, metaclass=MetaJavaClass):
    ...
    __javaconstructor__ = [("(Landroid/icu/util/TimeZone;)V", False), ("()V", False), ("(Landroid/icu/util/TimeZone;Landroid/icu/util/ULocale;)V", False), ("(Landroid/icu/util/TimeZone;Ljava/util/Locale;)V", False), ("(Landroid/icu/util/ULocale;)V", False), ("(III)V", False), ("(Ljava/util/Locale;)V", False), ("(Ljava/util/Date;)V", False), ("(IIIIII)V", False)]
