...
class MidiManager(JavaClass, metaclass=MetaJavaClass):
    ...
    registerDeviceCallback = JavaMultipleMethod([("(ILjava/util/concurrent/Executor;Landroid/media/midi/MidiManager$DeviceCallback;)V", False, False), ("(Landroid/media/midi/MidiManager$DeviceCallback;Landroid/os/Handler;)V", False, False)])
    ...
    class OnDeviceOpenedListener(JavaClass, metaclass=MetaJavaClass):
