...
class RoundRectShape(JavaClass, metaclass=MetaJavaClass):
    ...
    clone = JavaMultipleMethod([("()Landroid/graphics/drawable/shapes/RectShape;", False, False), ("()Landroid/graphics/drawable/shapes/RoundRectShape;", False, False), ("()Landroid/graphics/drawable/shapes/Shape;", False, False), ("()Ljava/lang/Object;", False, False)])
