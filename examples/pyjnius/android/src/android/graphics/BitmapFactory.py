...
class BitmapFactory(JavaClass, metaclass=MetaJavaClass):
    ...
    decodeResource = JavaMultipleMethod([("(Landroid/content/res/Resources;I)Landroid/graphics/Bitmap;", True, False), ("(Landroid/content/res/Resources;ILandroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;", True, False)])
    decodeFileDescriptor = JavaMultipleMethod([("(Ljava/io/FileDescriptor;)Landroid/graphics/Bitmap;", True, False), ("(Ljava/io/FileDescriptor;Landroid/graphics/Rect;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;", True, False)])
