...
class BackupAgent(JavaClass, metaclass=MetaJavaClass):
    ...
    onRestore = JavaMultipleMethod([("(Landroid/app/backup/BackupDataInput;JLandroid/os/ParcelFileDescriptor;)V", False, False), ("(Landroid/app/backup/BackupDataInput;ILandroid/os/ParcelFileDescriptor;)V", False, False)])
