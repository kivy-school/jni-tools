...
class AppFunctionService(JavaClass, metaclass=MetaJavaClass):
    __javaclass__ = "android/app/appfunctions/AppFunctionService"
    ...
    onExecuteFunction = JavaMethod("(Landroid/app/appfunctions/ExecuteAppFunctionRequest;Ljava/lang/String;Landroid/content/pm/SigningInfo;Landroid/os/CancellationSignal;Landroid/os/OutcomeReceiver;)V")
...
class AppFunctionManager(JavaClass, metaclass=MetaJavaClass):
    ...
    isAppFunctionEnabled = JavaMultipleMethod([("(Ljava/lang/String;Ljava/lang/String;Ljava/util/concurrent/Executor;Landroid/os/OutcomeReceiver;)V", False, False), ("(Ljava/lang/String;Ljava/util/concurrent/Executor;Landroid/os/OutcomeReceiver;)V", False, False)])
