...
class PreferenceActivity(JavaClass, metaclass=MetaJavaClass):
    ...
    startWithFragment = JavaMultipleMethod([("(Ljava/lang/String;Landroid/os/Bundle;Landroid/app/Fragment;III)V", False, False), ("(Ljava/lang/String;Landroid/os/Bundle;Landroid/app/Fragment;I)V", False, False)])
