...
class Channels(JavaClass, metaclass=MetaJavaClass):
    ...
    newWriter = JavaMultipleMethod([("(Ljava/nio/channels/WritableByteChannel;Ljava/lang/String;)Ljava/io/Writer;", True, False), ("(Ljava/nio/channels/WritableByteChannel;Ljava/nio/charset/CharsetEncoder;I)Ljava/io/Writer;", True, False), ("(Ljava/nio/channels/WritableByteChannel;Ljava/nio/charset/Charset;)Ljava/io/Writer;", True, False)])
    ...
    newReader = JavaMultipleMethod([("(Ljava/nio/channels/ReadableByteChannel;Ljava/nio/charset/Charset;)Ljava/io/Reader;", True, False), ("(Ljava/nio/channels/ReadableByteChannel;Ljava/lang/String;)Ljava/io/Reader;", True, False), ("(Ljava/nio/channels/ReadableByteChannel;Ljava/nio/charset/CharsetDecoder;I)Ljava/io/Reader;", True, False)])