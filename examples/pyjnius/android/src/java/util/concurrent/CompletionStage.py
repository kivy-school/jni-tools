...
class CompletionStage(JavaClass, metaclass=MetaJavaClass):
    ...
    runAfterEitherAsync = JavaMultipleMethod([("(Ljava/util/concurrent/CompletionStage;Ljava/lang/Runnable;Ljava/util/concurrent/Executor;)Ljava/util/concurrent/CompletionStage;", False, False), ("(Ljava/util/concurrent/CompletionStage;Ljava/lang/Runnable;)Ljava/util/concurrent/CompletionStage;", False, False)])
