...
class Collectors(JavaClass, metaclass=MetaJavaClass):
    ...
    joining = JavaMultipleMethod([("(Ljava/lang/CharSequence;)Ljava/util/stream/Collector;", True, False), ("(Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;)Ljava/util/stream/Collector;", True, False), ("()Ljava/util/stream/Collector;", True, False)])
    ...
    reducing = JavaMultipleMethod([("(Ljava/lang/Object;Ljava/util/function/Function;Ljava/util/function/BinaryOperator;)Ljava/util/stream/Collector;", True, False), ("(Ljava/util/function/BinaryOperator;)Ljava/util/stream/Collector;", True, False), ("(Ljava/lang/Object;Ljava/util/function/BinaryOperator;)Ljava/util/stream/Collector;", True, False)])
    groupingByConcurrent = JavaMultipleMethod([("(Ljava/util/function/Function;Ljava/util/function/Supplier;Ljava/util/stream/Collector;)Ljava/util/stream/Collector;", True, False), ("(Ljava/util/function/Function;Ljava/util/stream/Collector;)Ljava/util/stream/Collector;", True, False), ("(Ljava/util/function/Function;)Ljava/util/stream/Collector;", True, False)])
    ...
    toConcurrentMap = JavaMultipleMethod([("(Ljava/util/function/Function;Ljava/util/function/Function;Ljava/util/function/BinaryOperator;)Ljava/util/stream/Collector;", True, False), ("(Ljava/util/function/Function;Ljava/util/function/Function;Ljava/util/function/BinaryOperator;Ljava/util/function/Supplier;)Ljava/util/stream/Collector;", True, False), ("(Ljava/util/function/Function;Ljava/util/function/Function;)Ljava/util/stream/Collector;", True, False)])
    ...
    toUnmodifiableMap = JavaMultipleMethod([("(Ljava/util/function/Function;Ljava/util/function/Function;Ljava/util/function/BinaryOperator;)Ljava/util/stream/Collector;", True, False), ("(Ljava/util/function/Function;Ljava/util/function/Function;)Ljava/util/stream/Collector;", True, False)])
