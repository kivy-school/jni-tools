...
class TileService:
    ...
    @staticmethod
    def requestListeningState(p0: Context, p1: ComponentName) -> None: ...
    @overload
    def startActivityAndCollapse(self, p0: Intent) -> None: ...
    @overload
    def startActivityAndCollapse(self, p0: PendingIntent) -> None: ...
    def unlockAndRun(self, p0: Runnable) -> None: ...
    ...
    def showDialog(self, p0: Dialog) -> None: ...
