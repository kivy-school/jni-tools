...
class GestureOverlayView:
    ...
    def addOnGestureListener(self, p0: Any) -> None: ...
    def addOnGesturePerformedListener(self, p0: Any) -> None: ...
    def addOnGesturingListener(self, p0: Any) -> None: ...
    ...
    @overload
    def getGesturePath(self, p0: Path) -> Path: ...
    @overload
    ...
    def removeOnGestureListener(self, p0: Any) -> None: ...
    def removeOnGesturePerformedListener(self, p0: Any) -> None: ...
    def removeOnGesturingListener(self, p0: Any) -> None: ...
    def setEventsInterceptionEnabled(self, p0: bool) -> None: ...
    def setFadeEnabled(self, p0: bool) -> None: ...
    def setFadeOffset(self, p0: int) -> None: ...
    def setGesture(self, p0: Gesture) -> None: ...
    def setGestureColor(self, p0: int) -> None: ...
    def setGestureStrokeAngleThreshold(self, p0: float) -> None: ...
    def setGestureStrokeLengthThreshold(self, p0: float) -> None: ...
    def setGestureStrokeSquarenessTreshold(self, p0: float) -> None: ...
    def setGestureStrokeType(self, p0: int) -> None: ...
    def setGestureStrokeWidth(self, p0: float) -> None: ...
    def setGestureVisible(self, p0: bool) -> None: ...
    def setUncertainGestureColor(self, p0: int) -> None: ...
    def clear(self, p0: bool) -> None: ...
    ...
    class OnGesturingListener:
        def onGesturingEnded(self, p0: "GestureOverlayView") -> None: ...
        def onGesturingStarted(self, p0: "GestureOverlayView") -> None: ...

    class OnGesturePerformedListener:
        def onGesturePerformed(self, p0: "GestureOverlayView", p1: Gesture) -> None: ...

    class OnGestureListener:
        def onGestureCancelled(self, p0: "GestureOverlayView", p1: MotionEvent) -> None: ...
        def onGestureEnded(self, p0: "GestureOverlayView", p1: MotionEvent) -> None: ...
        def onGesture(self, p0: "GestureOverlayView", p1: MotionEvent) -> None: ...
        def onGestureStarted(self, p0: "GestureOverlayView", p1: MotionEvent) -> None: ...
