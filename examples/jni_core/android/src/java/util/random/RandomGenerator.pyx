...
cdef jmethodID _m_RandomGenerator_equiDoubles_0 = NULL
...
cdef int _ensure_ids_RandomGenerator(JNIEnv* env) except -1:
    global _cls_RandomGenerator, _m_RandomGenerator_nextBoolean_0, _m_RandomGenerator_nextLong_0, _m_RandomGenerator_nextLong_1, _m_RandomGenerator_nextLong_2, _m_RandomGenerator_longs_0, _m_RandomGenerator_longs_1, _m_RandomGenerator_longs_2, _m_RandomGenerator_longs_3, _m_RandomGenerator_nextFloat_0, _m_RandomGenerator_nextFloat_1, _m_RandomGenerator_nextFloat_2, _m_RandomGenerator_ints_0, _m_RandomGenerator_ints_1, _m_RandomGenerator_ints_2, _m_RandomGenerator_ints_3, _m_RandomGenerator_doubles_0, _m_RandomGenerator_doubles_1, _m_RandomGenerator_doubles_2, _m_RandomGenerator_doubles_3, _m_RandomGenerator_nextGaussian_0, _m_RandomGenerator_nextGaussian_1, _m_RandomGenerator_isDeprecated_0, _m_RandomGenerator_equiDoubles_0, _m_RandomGenerator_nextExponential_0, _m_RandomGenerator_of_0, _m_RandomGenerator_getDefault_0, _m_RandomGenerator_nextDouble_0, _m_RandomGenerator_nextDouble_1, _m_RandomGenerator_nextDouble_2, _m_RandomGenerator_nextInt_0, _m_RandomGenerator_nextInt_1, _m_RandomGenerator_nextInt_2, _m_RandomGenerator_nextBytes_0
    ...
    _m_RandomGenerator_longs_0 = get_method_id(env, _cls_RandomGenerator, b"longs", b"()Ljava/util/stream/LongStream;")
    _m_RandomGenerator_longs_1 = get_method_id(env, _cls_RandomGenerator, b"longs", b"(JJ)Ljava/util/stream/LongStream;")
    _m_RandomGenerator_longs_2 = get_method_id(env, _cls_RandomGenerator, b"longs", b"(J)Ljava/util/stream/LongStream;")
    _m_RandomGenerator_longs_3 = get_method_id(env, _cls_RandomGenerator, b"longs", b"(JJJ)Ljava/util/stream/LongStream;")
    _m_RandomGenerator_nextFloat_0 = get_method_id(env, _cls_RandomGenerator, b"nextFloat", b"(F)F")
    _m_RandomGenerator_nextFloat_1 = get_method_id(env, _cls_RandomGenerator, b"nextFloat", b"(FF)F")
    _m_RandomGenerator_nextFloat_2 = get_method_id(env, _cls_RandomGenerator, b"nextFloat", b"()F")
    _m_RandomGenerator_ints_0 = get_method_id(env, _cls_RandomGenerator, b"ints", b"()Ljava/util/stream/IntStream;")
    _m_RandomGenerator_ints_1 = get_method_id(env, _cls_RandomGenerator, b"ints", b"(II)Ljava/util/stream/IntStream;")
    _m_RandomGenerator_ints_2 = get_method_id(env, _cls_RandomGenerator, b"ints", b"(JII)Ljava/util/stream/IntStream;")
    _m_RandomGenerator_ints_3 = get_method_id(env, _cls_RandomGenerator, b"ints", b"(J)Ljava/util/stream/IntStream;")
    _m_RandomGenerator_doubles_0 = get_method_id(env, _cls_RandomGenerator, b"doubles", b"(JDD)Ljava/util/stream/DoubleStream;")
    _m_RandomGenerator_doubles_1 = get_method_id(env, _cls_RandomGenerator, b"doubles", b"()Ljava/util/stream/DoubleStream;")
    _m_RandomGenerator_doubles_2 = get_method_id(env, _cls_RandomGenerator, b"doubles", b"(DD)Ljava/util/stream/DoubleStream;")
    _m_RandomGenerator_doubles_3 = get_method_id(env, _cls_RandomGenerator, b"doubles", b"(J)Ljava/util/stream/DoubleStream;")
    ...
    _m_RandomGenerator_equiDoubles_0 = get_method_id(env, _cls_RandomGenerator, b"equiDoubles", b"(DDZZ)Ljava/util/stream/DoubleStream;")
    ...
    _m_RandomGenerator_nextInt_1 = get_method_id(env, _cls_RandomGenerator, b"nextInt", b"(II)I")
    _m_RandomGenerator_nextInt_2 = get_method_id(env, _cls_RandomGenerator, b"nextInt", b"()I")
...
cdef class RandomGenerator(JavaObject):
    ...
    def longs_0(self) -> object:
        cdef JNIEnv* env = get_env()
        cdef jobject _ret = NULL
        _ret = self._longs_0(env)
        if _ret == NULL:
            return None
        cdef JavaObject _wrapped = JavaObject.__new__(JavaObject)
        _wrapped._adopt_local(env, _ret)
    ...
    def longs_2(self, p0) -> object:
        cdef JNIEnv* env = get_env()
        cdef jobject _ret = NULL
        cdef jlong _c0 = py_to_jlong(p0)
        _ret = self._longs_2(env, _c0)
        if _ret == NULL:
            return None
        cdef JavaObject _wrapped = JavaObject.__new__(JavaObject)
        _wrapped._adopt_local(env, _ret)
    ...
    def longs_3(self, p0, p1, p2) -> object:
        cdef JNIEnv* env = get_env()
        cdef jobject _ret = NULL
        cdef jlong _c0 = py_to_jlong(p0)
        cdef jlong _c1 = py_to_jlong(p1)
        cdef jlong _c2 = py_to_jlong(p2)
        _ret = self._longs_3(env, _c0, _c1, _c2)
        if _ret == NULL:
            return None
        cdef JavaObject _wrapped = JavaObject.__new__(JavaObject)
        _wrapped._adopt_local(env, _ret)
    ...
    def nextFloat_1(self, p0, p1) -> float:
        cdef JNIEnv* env = get_env()
        cdef jfloat _ret = 0.0
        cdef jfloat _c0 = py_to_jfloat(p0)
        cdef jfloat _c1 = py_to_jfloat(p1)
        _ret = self._nextFloat_1(env, _c0, _c1)
        return <double>_ret
    ...
    def ints_0(self) -> object:
        cdef JNIEnv* env = get_env()
        cdef jobject _ret = NULL
        _ret = self._ints_0(env)
        if _ret == NULL:
            return None
        cdef JavaObject _wrapped = JavaObject.__new__(JavaObject)
        _wrapped._adopt_local(env, _ret)
    ...
    def doubles(self, p0, p1, p2) -> object:
        ...
        _ret = self._doubles(env, _c0, _c1, _c2)
        if _ret == NULL:
            return None
        cdef JavaObject _wrapped = JavaObject.__new__(JavaObject)
        _wrapped._adopt_local(env, _ret)
    ...
    def doubles_0(self, p0, p1, p2) -> object:
        cdef JNIEnv* env = get_env()
        cdef jobject _ret = NULL
        cdef jlong _c0 = py_to_jlong(p0)
        cdef jdouble _c1 = py_to_jdouble(p1)
        cdef jdouble _c2 = py_to_jdouble(p2)
        _ret = self._doubles_0(env, _c0, _c1, _c2)
        if _ret == NULL:
            return None
        cdef JavaObject _wrapped = JavaObject.__new__(JavaObject)
        _wrapped._adopt_local(env, _ret)
    ...
    def doubles_1(self) -> object:
        cdef JNIEnv* env = get_env()
        cdef jobject _ret = NULL
        _ret = self._doubles_1(env)
        if _ret == NULL:
            return None
        cdef JavaObject _wrapped = JavaObject.__new__(JavaObject)
        _wrapped._adopt_local(env, _ret)
    ...
    def doubles_2(self, p0, p1) -> object:
        cdef JNIEnv* env = get_env()
        cdef jobject _ret = NULL
        cdef jdouble _c0 = py_to_jdouble(p0)
        cdef jdouble _c1 = py_to_jdouble(p1)
        _ret = self._doubles_2(env, _c0, _c1)
        if _ret == NULL:
            return None
        cdef JavaObject _wrapped = JavaObject.__new__(JavaObject)
        _wrapped._adopt_local(env, _ret)
    ...
    def nextGaussian_1(self, p0, p1) -> float:
        cdef JNIEnv* env = get_env()
        cdef jdouble _ret = 0.0
        cdef jdouble _c0 = py_to_jdouble(p0)
        cdef jdouble _c1 = py_to_jdouble(p1)
        _ret = self._nextGaussian_1(env, _c0, _c1)
        return <double>_ret
    ...
    cdef jobject _equiDoubles(self, JNIEnv* env, jdouble p0, jdouble p1, jboolean p2, jboolean p3) except? NULL:
        ...
        _args[2].z = p2
        _args[3].z = p3
        cdef jobject _ret = jnicore_CallObjectMethodA(env, self._handle, _m_RandomGenerator_equiDoubles_0, _args)
        check_jni_exc(env)
        return _ret

    def equiDoubles(self, p0, p1, p2, p3) -> object:
        cdef JNIEnv* env = get_env()
        cdef jobject _ret = NULL
        cdef jdouble _c0 = py_to_jdouble(p0)
        cdef jdouble _c1 = py_to_jdouble(p1)
        ...
        _ret = self._equiDoubles(env, _c0, _c1, _c2, _c3)
        if _ret == NULL:
            return None
        cdef JavaObject _wrapped = JavaObject.__new__(JavaObject)
        _wrapped._adopt_local(env, _ret)
    ...
    def equiDoubles_0(self, p0, p1, p2, p3) -> object:
        cdef JNIEnv* env = get_env()
        cdef jobject _ret = NULL
        cdef jdouble _c0 = py_to_jdouble(p0)
        cdef jdouble _c1 = py_to_jdouble(p1)
        cdef jboolean _c2 = py_to_jboolean(p2)
        cdef jboolean _c3 = py_to_jboolean(p3)
        _ret = self._equiDoubles_0(env, _c0, _c1, _c2, _c3)
        if _ret == NULL:
            return None
        cdef JavaObject _wrapped = JavaObject.__new__(JavaObject)
        _wrapped._adopt_local(env, _ret)
    ...
    def nextDouble_1(self, p0) -> float:
        cdef JNIEnv* env = get_env()
        cdef jdouble _ret = 0.0
        cdef jdouble _c0 = py_to_jdouble(p0)
        _ret = self._nextDouble_1(env, _c0)
        return <double>_ret
    ...
    def nextDouble_2(self, p0, p1) -> float:
        cdef JNIEnv* env = get_env()
        cdef jdouble _ret = 0.0
        cdef jdouble _c0 = py_to_jdouble(p0)
        cdef jdouble _c1 = py_to_jdouble(p1)
        _ret = self._nextDouble_2(env, _c0, _c1)
        return <double>_ret
    ...
    def nextInt_1(self, p0, p1) -> int:
        cdef JNIEnv* env = get_env()
        cdef jint _ret = 0
        cdef jint _c0 = py_to_jint(p0)
        cdef jint _c1 = py_to_jint(p1)
        _ret = self._nextInt_1(env, _c0, _c1)
        return <int>_ret
...
cdef int _ensure_ids_ArbitrarilyJumpableGenerator(JNIEnv* env) except -1:
    global _cls_ArbitrarilyJumpableGenerator, _m_ArbitrarilyJumpableGenerator_jump_0, _m_ArbitrarilyJumpableGenerator_jump_1, _m_ArbitrarilyJumpableGenerator_of_0, _m_ArbitrarilyJumpableGenerator_copy_0, _m_ArbitrarilyJumpableGenerator_copy_1, _m_ArbitrarilyJumpableGenerator_copy_2, _m_ArbitrarilyJumpableGenerator_leap_0, _m_ArbitrarilyJumpableGenerator_jumps_0, _m_ArbitrarilyJumpableGenerator_jumps_1, _m_ArbitrarilyJumpableGenerator_copyAndJump_0, _m_ArbitrarilyJumpableGenerator_jumpPowerOfTwo_0
    ...
    _m_ArbitrarilyJumpableGenerator_jump_0 = get_method_id(env, _cls_ArbitrarilyJumpableGenerator, b"jump", b"(D)V")
    _m_ArbitrarilyJumpableGenerator_jump_1 = get_method_id(env, _cls_ArbitrarilyJumpableGenerator, b"jump", b"()V")
    ...
    _m_ArbitrarilyJumpableGenerator_copy_1 = get_method_id(env, _cls_ArbitrarilyJumpableGenerator, b"copy", b"()Ljava/util/random/RandomGenerator$ArbitrarilyJumpableGenerator;")
    _m_ArbitrarilyJumpableGenerator_copy_2 = get_method_id(env, _cls_ArbitrarilyJumpableGenerator, b"copy", b"()Ljava/util/random/RandomGenerator$JumpableGenerator;")
...
cdef class ArbitrarilyJumpableGenerator(JavaObject):
    ...
    def jump_0(self, p0) -> None:
        cdef JNIEnv* env = get_env()
        cdef jdouble _c0 = py_to_jdouble(p0)
        self._jump_0(env, _c0)
...
cdef int _ensure_ids_JumpableGenerator(JNIEnv* env) except -1:
    global _cls_JumpableGenerator, _m_JumpableGenerator_rngs_0, _m_JumpableGenerator_rngs_1, _m_JumpableGenerator_jump_0, _m_JumpableGenerator_of_0, _m_JumpableGenerator_copy_0, _m_JumpableGenerator_jumpDistance_0, _m_JumpableGenerator_jumps_0, _m_JumpableGenerator_jumps_1, _m_JumpableGenerator_copyAndJump_0
...
cdef int _ensure_ids_SplittableGenerator(JNIEnv* env) except -1:
    global _cls_SplittableGenerator, _m_SplittableGenerator_splits_0, _m_SplittableGenerator_splits_1, _m_SplittableGenerator_splits_2, _m_SplittableGenerator_splits_3, _m_SplittableGenerator_rngs_0, _m_SplittableGenerator_rngs_1, _m_SplittableGenerator_of_0, _m_SplittableGenerator_split_0, _m_SplittableGenerator_split_1
    ...
    _m_SplittableGenerator_splits_1 = get_method_id(env, _cls_SplittableGenerator, b"splits", b"(J)Ljava/util/stream/Stream;")
    _m_SplittableGenerator_splits_2 = get_method_id(env, _cls_SplittableGenerator, b"splits", b"()Ljava/util/stream/Stream;")
    _m_SplittableGenerator_splits_3 = get_method_id(env, _cls_SplittableGenerator, b"splits", b"(Ljava/util/random/RandomGenerator$SplittableGenerator;)Ljava/util/stream/Stream;")
...
cdef class SplittableGenerator(JavaObject):
    ...
    def splits_2(self) -> object:
        cdef JNIEnv* env = get_env()
        cdef jobject _ret = NULL
        _ret = self._splits_2(env)
        if _ret == NULL:
            return None
        cdef JavaObject _wrapped = JavaObject.__new__(JavaObject)
        _wrapped._adopt_local(env, _ret)
...
cdef int _ensure_ids_StreamableGenerator(JNIEnv* env) except -1:
    global _cls_StreamableGenerator, _m_StreamableGenerator_rngs_0, _m_StreamableGenerator_rngs_1, _m_StreamableGenerator_of_0
