// CythonEmitter pipeline. Mirrors PyjniusWrapCore.Pipeline but routes the
...
public struct CythonPipeline: Sendable {
    ...
    public func emit(doc: AstDocument, opts: Options) throws -> [URL] {
        ...
        // as PyjniusWrapCore.Pipeline.emit — copied because Pipeline keeps
